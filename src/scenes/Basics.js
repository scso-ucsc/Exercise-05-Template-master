class Basics extends Phaser.Scene {
    ...
    create() {
        ...
        let verygoodpear = this.add.sprite(64, 64, "fruitandveg", "pear"); //Adding pear
        ...
        //Creating Tween Chain
        let pearTweenChain = this.tweens.chain({
            targets: verygoodpear, //Target is verygoodpear
            ease: "Bounce.easeOut", //Adding bounce ease out option; Default option
            loop: 1,
            paused: true, //False during testing purposes; Prevents immediate movement
            tweens: [
                {
                    x: w - 64, //Tween for x property
                    duration: 500 //Tween will take 0.5 seconds
                },
                {
                    angle: 90, //Adding rotation
                    duration: 500
                },
                {
                    y: h - 64,
                    duration: 1000,
                    ease: "Sine.easeOut" //Custom ease option
                },
                {
                    angle: 180, //Adding rotation
                    duration: 500
                },
                {
                    x: 64,
                ...
                {
                    angle: { from: 180, to: 270 }, //Adding rotation
                    duration: 500
                },
                {
                    y: 65,
                ...
                {
                    angle: 0, //Adding rotation
                    duration: 500
                }
            ] //Array of objects tweens
        });

        //Adding mouse input listener
        this.input.on("pointerdown", () => { //On mouse click
            verygoodpear.setAngle(0); //Resetting angle of pear
            verygoodpear.setPosition(64, 64); //Reset pear's position to original
